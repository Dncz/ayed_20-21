...
class maze_t {
 private:
  ...
  // matriz que guarda la solución del laberinto
  matrix_t_short road_;
  // matriz que guarda la otra solución del laberinto
  matrix_t_short otherRoad_;
 ...
 public:
  ...
  void road_write(ostream & = cout) const;
  // modificación
  void other_road(ostream & = cout) const;
